<%-- 
    Document   : myCostumers
    Created on : 05 3, 19, 2:24:52 AM
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <% 
                            ...
                            List<GetSetProducts> list = product.selectUsersCostumersProduct(userID);
                            ...
                            <div class="form-control" style="height: 400px;padding: 0px;">
                                ...
                                <div style="background-color:#353535;padding: 10px;color:white;margin: 0px;">
                                        ...
                                        <h5><b>Status:</b><% if(prodList.getStatus() == 2){
                                            out.print("<p style='color:green'><b>Order has been Receive</b></p>");
                                        }else if(prodList.getStatus() == 1){
                                            out.print("<p style='color:green'>Order is being Shipped</p>");
                                        }else{
                                            out.print("<p style='color:orange'>New Order</p>");
                                            %>
                                                <form action="confirmOrder" method="POST">
                                                    <input type="text" name="prodID" value="<%= prodList.getProductID() %>" hidden/>
                                                     
                                                    <input type="submit" name="submit" class="btn btn-sm btn-warning" style="color:black" value="Shipped Order" />
                                                </form>
                                            <%
                                        } %>
